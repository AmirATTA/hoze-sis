					...
					<table class="table  table-vcenter text-nowrap table-bordered border-bottom" id="job-list">
						...
						<tbody>
							...
							<tr>
								...
								<td>{{ $data->title }}</td>
								<td>
									<img src="{{ asset('storage/news/'.$data->image) }}" class="img-thumbnail rounded" style="max-width: 60px;">
								</td>
								...
								<td>
									<div class="d-flex">
										<a href="{{ route('news.show', $data->id) }}" class="action-btns1" data-toggle="tooltip" data-placement="top" title="" data-original-title="نمایش">
											<i class="feather feather-eye text-primary"></i>
										</a>
										<a href="{{ route('news.edit', $data->id) }}" class="action-btns1">
											<i class="feather feather-edit-2  text-success" data-toggle="tooltip" data-placement="top" title="" data-original-title="ویرایش"></i>
										</a>
										<a href="#" data-id="{{ $data->id }}" class="action-btns1 role-news" data-toggle="tooltip" data-placement="top" title="" data-original-title="حذف">
