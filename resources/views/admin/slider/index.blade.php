					...
					<table class="table  table-vcenter text-nowrap table-bordered border-bottom" id="job-list">
						...
						<tbody>
							...
							<tr>
								...
								<td>{{ $data->link }}</td>
								<td>
									<img src="{{ asset('storage/slider/'.$data->image) }}" class="img-thumbnail rounded" style="max-width: 60px;">
								</td>
								@if ($data->status == '1')
									<td>
								...
								<td>
									<div class="d-flex">
										<a href="{{ route('sliders.show', $data->id) }}" class="action-btns1" data-toggle="tooltip" data-placement="top" title="" data-original-title="نمایش">
											<i class="feather feather-eye text-primary"></i>
										</a>
										<a href="{{ route('sliders.edit', $data->id) }}" class="action-btns1">
											<i class="feather feather-edit-2  text-success" data-toggle="tooltip" data-placement="top" title="" data-original-title="ویرایش"></i>
										</a>
										<a href="#" data-id="{{ $data->id }}" class="action-btns1 role-slider" data-toggle="tooltip" data-placement="top" title="" data-original-title="حذف">
