		...
		<div class="card">
			<div class="card-body">
				<div class="table-responsive">
					<table class="table  table-vcenter text-nowrap table-bordered border-bottom" id="job-list">
						...
						<tbody>
							...
							<tr>
								...
								<td>{{ $data->title }}</td>
								<td>
									<img src="{{ asset('storage/article/'.$data->image) }}" class="img-thumbnail" style="max-width: 100px;">
								</td>
					...
					@if(count($article) === 0)
						<div class="text-center text-danger display-6" style="font-family: unset;">هیچ داده ای وجود ندارد</div>
					@endif
				</div>
